...
type RuntimeMessageListener = (
  message:
    ...
    | import("./Messages").ArchiveManuallyMessageRequest,
  sender: RuntimeMessageSender,
  sendResponse: RuntimeMessageResponseFunction
) => void;

declare interface RuntimeMessageListeners
  extends Listeners<RuntimeMessageListener> {}

declare interface RuntimePortListener
  extends Listeners<(object: Record<string, unknown>) => void> {}
...
declare interface RuntimeConnectListener
  extends Listeners<(port: RuntimePort) => void> {}
...
declare interface Runtime {
  ...
  sendMessage(
    message: import("./Messages").GetArchiveStatusMessageRequest
  ): Promise<import("./Messages").GetArchiveStatusResponse>;
  sendMessage(
    message: import("./Messages").ArchiveManuallyMessageRequest
  ): Promise<void>;
...
declare interface BrowserWindowCreatedListeners
  extends Listeners<(window: BrowserWindow) => void> {}
...
declare interface Menus {
  ...
  create(
    createProperties: MenuCreateProperties,
    callback?: () => void
