...
Copyright 2019-2020 Brummolix (new version AutoarchiveReloaded, https://github.com/Brummolix/AutoarchiveReloaded )
 ...
 This file was originally part of AutoarchiveReloaded.
...
export class LogLevelInfoWebExtension implements LogLevelInfo {
  private static readonly ENABLE_INFO_LOGGING_NAME: string =
    "WebExtensionLoggerHelper_enableInfoLogging";

  public static setGlobaleEnableInfoLogging(value: boolean): void {
    // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
    (browser.extension.getBackgroundPage() as any)[
      LogLevelInfoWebExtension.ENABLE_INFO_LOGGING_NAME
    ] = value;
  ...
  private static getGlobalEnableInfoLogging(): boolean {
    // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
    return (browser.extension.getBackgroundPage() as any)[
      LogLevelInfoWebExtension.ENABLE_INFO_LOGGING_NAME
    ] as boolean;
  }
